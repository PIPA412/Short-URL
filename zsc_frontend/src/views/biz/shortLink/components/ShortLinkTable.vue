      ...
      <div v-if="statsData" class="stats-body">
        <el-descriptions :column="2" border>
          ...
          <el-descriptions-item label="总点击量">
            <span class="stats-highlight">{{ statsData.totalClicks || 0 }}</span>
          </el-descriptions-item>
          <el-descriptions-item label="标题" :span="2">{{ statsData.title || '-' }}</el-descriptions-item>
          ...
          <el-descriptions-item label="创建者">{{ statsData.createBy }}</el-descriptions-item>
...
function handleStats(row) {
  ...
  getShortLinkStats(row.linkId).then(res => {
